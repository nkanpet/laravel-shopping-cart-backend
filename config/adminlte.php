        ...
        [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/bootstrap-fileinput/js/plugins/piexif.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/bootstrap-fileinput/js/plugins/sortable.min.js',
                ],
                // [
                //     'type' => 'js',
                //     'asset' => true,
                //     'location' => 'vendor/bootstrap-fileinput/js/plugins/purify.min.js',
                // ],
                [
                    'type' => 'js',
                    'asset' => true,
